<?php 
//TO REMOVE
//UNDER NEW FRAMEWORK, THIS IS NOT NEEDED.
//MOVE TO LOCAL THEME FOLDER

if (isset($showActionButton)):?>
...
<?php if (isset($showActionBar)):?>
    <div class="action-bar">
        ...
        <?php
            echo CHtml::tag('span',array('class'=>'icon'),CHtml::link('<i class="fa fa-comment-o"></i>','javascript::void(0)',array('onclick'=>$this->loadProductCommentScript($data,false),'title'=>Sii::t('sii','Write a comment'))));
