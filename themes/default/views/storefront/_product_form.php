            ...
            array(
                'image-column'=>array(
                    'image'=>$this->simagezoomerWidget(array('imageOwner'=>$model),true),
                                        'cssClass'=>$model->getImagesCount()>1?SPageLayout::WIDTH_38PERCENT:SPageLayout::WIDTH_35PERCENT,
                    //'width'=>$model->getImagesCount()>1?'0.38':'0.35',
                    'visible'=>!isset($modal),
                ),
            ),        
            array(
                ...
                array('name'=>'quantity',
                      ...
                      'value'=>CHtml::activeDropDownList(
                                    ...
                                    array('prompt'=>'',
                                          ...
                                          'data-placeholder'=>Sii::t('sii','Select Quantity'),
                                          'style'=>'width:80px')).
