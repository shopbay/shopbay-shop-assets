<div class="product">
    ...
    <a href="javascript:void(0);" onclick="<?php echo $this->loadProductViewScript($data,$page);?>">
        <?php echo $data->getImageThumbnail(Image::VERSION_ORIGINAL,['class'=>'img'],$data->displayLanguageValue('name',user()->getLocale()));?>
    </a>
    ...
    <?php if (!$data->hasInventory()):?>
        <div class="offer-tag">
            <?php echo $data->getInventoryText();?>
        </div>
    <?php endif;?>
